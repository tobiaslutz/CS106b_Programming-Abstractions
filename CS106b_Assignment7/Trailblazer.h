...
/* Type: NodeStatus
 *
 * A type representing the status of a location in a grid, i.e., the color and the parent node. 
 */
struct NodeStatus {
    Color col;
    double dist;
...
/* Type: Direction
 *
 * A type representing all possible directions from a location in a grid
 */
